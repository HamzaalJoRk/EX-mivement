...
@section('content')
    <div class="container">
        <h1 class="mb-1">إنشاء حركة دخول عن طريق رقم الدفتر</h1>

        <form action="{{ route('entry_statements.searchBook') }}" method="GET" class="mb-1">
            <div class="row">
                <div class="col-md-6">
        ...
        @if(isset($foundEntry))
            ...
            <form action="{{ route('entry_statements.storeFromBook') }}" method="POST">
                @csrf
