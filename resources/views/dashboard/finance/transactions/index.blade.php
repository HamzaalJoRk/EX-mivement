            ...
            <form method="GET" action="{{ route('finance.box.transactions', $box->id) }}" class="mb-4">
                <div class="row justify-content-center align-items-end g-2">
                    ...
                    <div class="col-md-2 d-flex gap-2">
                        ...
                        <a href="{{ route('finance.box.transactions', $box->id) }}" class="btn btn-secondary w-100">إلغاء
                            الفلترة</a>
                    </div>
                </div>
            </form>
                        ...
                        @foreach ($transactions as $t)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('print.card', $t->id) }}" target="_blank" class="mb-0 btn-sm btn btn-success">
